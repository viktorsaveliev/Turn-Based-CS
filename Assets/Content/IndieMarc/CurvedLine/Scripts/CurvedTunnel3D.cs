...
namespace IndieMarc.CurvedLine
{
    ...
    public class CurvedTunnel3D : MonoBehaviour
    {
        ...
        private void BuildMesh()
        {
            ...
            int varray_length = mesh_dots * nb_points_max;
            int tarray_length = mesh_dots * nb_points_max * 6;
            ...
            for (int i = 0; i < nb_points_max; i++)
            {
                ...
                for (int a = 0; a < mesh_dots; a++)
                {
                    ...
                    {
                        triangles[vindex * 6 + 0] = vnext;
                        triangles[vindex * 6 + 1] = vindex;
                        triangles[vindex * 6 + 2] = vindex + mesh_dots;
                        
                        triangles[vindex * 6 + 3] = vnext + mesh_dots;
                        triangles[vindex * 6 + 4] = vnext;
